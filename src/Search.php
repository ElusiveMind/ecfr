...
final class Search {
   ...
   */
  public function countsHierarchy(SearchRequestor $objRequestor) : array {
    $objUri = new Uri();
   ...
   */
  private function execute(SearchRequestor $objRequestor, Uri $objUri, string $strPath) : array {
